    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p class="modal-description">
                Share this invite code with family members to let them join:
            </p>
            
            <div class="invite-code-box">
                <code id="modalInviteCode"><?php echo htmlspecialchars($family['invite_code']); ?></code>
            </div>

            <button onclick="copyInviteCode()" class="btn btn-primary btn-block">
                📋 Copy Invite Code
            </button>
            ...
            <div class="invite-instructions">
                <h3>How to invite:</h3>
                <ol>
                    <li>Share the invite code above</li>
                    <li>They visit <strong>relatives.co.za/register-join.php</strong></li>
                    <li>They choose "Join Family" and enter the code</li>
                    <li>They'll be added to your family!</li>
                </ol>
            </div>
        </div>
    </div>
