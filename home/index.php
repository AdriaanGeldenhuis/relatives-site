        ...
        <section class="hero-section" data-time="<?php echo $greetingColor; ?>">
            <div class="greeting-card">
                ...
                <div class="quick-actions">
                    <button class="quick-action-btn" onclick="RelativesVoice.openModal()" aria-label="Open voice command">
                        <span class="qa-icon" aria-hidden="true">🎤</span>
                        <span class="qa-text">Voice Command</span>
                    </button>
                    <button class="quick-action-btn" onclick="AIAssistant.openSmartSearch()" aria-label="Open smart search">
                        <span class="qa-icon" aria-hidden="true">🔍</span>
                        <span class="qa-text">Smart Search</span>
                    </button>
